"main";"use strict";;_cad‍.x([["io",()=>io],["savePlayer",()=>savePlayer]]);let express;_cad‍.w("express",[["default",["express"],function(v){express=v}]]);let http;_cad‍.w("http",[["default",["http"],function(v){http=v}]]);let path;_cad‍.w("path",[["default",["path"],function(v){path=v}]]);let socketIO;_cad‍.w("socket.io",[["default",["socketIO"],function(v){socketIO=v}]]);let fs;_cad‍.w("fs/promises",[["default",["fs"],function(v){fs=v}]]);let players,bullets,walls;_cad‍.w("./modules/Game.js",[["players",["players"],function(v){players=v}],["bullets",["bullets"],function(v){bullets=v}],["walls",["walls"],function(v){walls=v}]]);let Player;_cad‍.w("./modules/Player.js",[["Player",["Player"],function(v){Player=v}]]);let BotPlayer;_cad‍.w("./modules/BotPlayer.js",[["BotPlayer",["BotPlayer"],function(v){BotPlayer=v}]]);
_cad‍.g.console.log(process.version);
...
readDataDirectory().then(data => {
  ...
  readDataFile(data[0]).then(xyz=>{_cad‍.g.console.log(xyz)});
...
io.on("connection", function(socket) {
  _cad‍.g.console.log("io.on connection");
  let player = null;

  socket.on("game-start", config => {
    _cad‍.g.console.log("socket on game-start");
    player = new Player({
      socketId: socket.id,
...
const port = 3000;
server.listen(port, () => {
  _cad‍.g.console.log(`Starting server on port ${port}`);
});
